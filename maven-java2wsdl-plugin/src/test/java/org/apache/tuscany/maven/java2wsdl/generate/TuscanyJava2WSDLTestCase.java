...
import org.apache.tuscany.maven.java2wsdl.generate.Java2WSDL;
...
public class TuscanyJava2WSDLTestCase extends TestCase {
    ...
    public void testSimpleWSDLGeneration() {
        String[] arguments =
            new String[] {"-cn", "org.apache.tuscany.maven.java2wsdl.generate.CustomerValue", 
                          "-o",  "target/java2wsdl-source", "-xc",
                          "org.apache.tuscany.maven.java2wsdl.generate.extra.GoldCustomer"};
    ...
    public void testWsdlGeneration2() {
        ...
        String[] arguments =
            new String[] {"-cn", "org.apache.tuscany.maven.java2wsdl.generate.CustomerWithAccount", 
    ...
    public void testServiceWSDLGeneration() {
        String[] arguments =
            new String[] {"-cn", "org.apache.tuscany.maven.java2wsdl.generate.ExampleService", 
                          "-o",  "target/java2wsdl-source"};
